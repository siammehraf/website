...
//       strings: ['Writing', 'Film Making', 'Web Development', 'Programming', '& Many More..'],
//       typeSpeed: 50,
//     });
...
//             I am <span className="font-semibold">Siam Mehraf.</span> I Love <br className="hidden lg:block" /> o Do..{' '}
//             <span className="font-semibold underline decoration-primary">
//               <span ref={el} />
//             </span>
//           </h1> */}

//           <h1 className="text-3xl sm:text-2xl md:text-3xl font-normal leading-snug">
//             I am <span className="font-semibold">Siam Mehraf.</span>
//             <br /> {/* Always breaks line on mobile */}I love{' '}
//             <span className="font-semibold underline decoration-primary">
//               <span ref={el} />
//             </span>
//           </h1>
...
//               className="flex flex-wrap justify-between md:flex-row"></form>
//           </div>
//         </div>
